...
const CHAINS = [
  ...
  { name: 'BNB Chain',    group: 'EVM', logo: 'images/bnb.png',       curve: 'secp256k1', addrLen: 42, encoding: 'Hex (0x)', derivation: "m/44'/60'/0'/0/0", mnemonic: true, chainId: 56 },
  { name: 'Polygon',      group: 'EVM', logo: 'images/polygon.png',   curve: 'secp256k1', addrLen: 42, encoding: 'Hex (0x)', derivation: "m/44'/60'/0'/0/0", mnemonic: true, chainId: 137 },
  { name: 'Arbitrum',     group: 'EVM', logo: 'images/arbitrum.png',  curve: 'secp256k1', addrLen: 42, encoding: 'Hex (0x)', derivation: "m/44'/60'/0'/0/0", mnemonic: true, chainId: 42161 },
  { name: 'Optimism',     group: 'EVM', logo: 'images/optimism.png',  curve: 'secp256k1', addrLen: 42, encoding: 'Hex (0x)', derivation: "m/44'/60'/0'/0/0", mnemonic: true, chainId: 10 },
  { name: 'Base',         group: 'EVM', logo: 'images/base.png',      curve: 'secp256k1', addrLen: 42, encoding: 'Hex (0x)', derivation: "m/44'/60'/0'/0/0", mnemonic: true, chainId: 8453 },
  { name: 'zkSync Era',   group: 'EVM', logo: 'images/zksync.png',    curve: 'secp256k1', addrLen: 42, encoding: 'Hex (0x)', derivation: "m/44'/60'/0'/0/0", mnemonic: true, chainId: 324 },
  { name: 'Avalanche',    group: 'EVM', logo: 'images/avalanche.png', curve: 'secp256k1', addrLen: 42, encoding: 'Hex (0x)', derivation: "m/44'/60'/0'/0/0", mnemonic: true, chainId: 43114 },
  { name: 'Fantom',       group: 'EVM', logo: 'images/fantom.png',    curve: 'secp256k1', addrLen: 42, encoding: 'Hex (0x)', derivation: "m/44'/60'/0'/0/0", mnemonic: true, chainId: 250 },
  { name: 'Cronos',       group: 'EVM', logo: 'images/cronos.png',    curve: 'secp256k1', addrLen: 42, encoding: 'Hex (0x)', derivation: "m/44'/60'/0'/0/0", mnemonic: true, chainId: 25 },
  { name: 'Gnosis',       group: 'EVM', logo: 'images/gnosis.png',    curve: 'secp256k1', addrLen: 42, encoding: 'Hex (0x)', derivation: "m/44'/60'/0'/0/0", mnemonic: true, chainId: 100 },
  { name: 'Celo',         group: 'EVM', logo: 'images/celo.png',      curve: 'secp256k1', addrLen: 42, encoding: 'Hex (0x)', derivation: "m/44'/60'/0'/0/0", mnemonic: true, chainId: 42220 },
  { name: 'Moonbeam',     group: 'EVM', logo: 'images/moonbeam.png',  curve: 'secp256k1', addrLen: 42, encoding: 'Hex (0x)', derivation: "m/44'/60'/0'/0/0", mnemonic: true, chainId: 1284 },
  { name: 'Harmony',      group: 'EVM', logo: 'images/harmony.png',   curve: 'secp256k1', addrLen: 42, encoding: 'Hex (0x)', derivation: "m/44'/60'/0'/0/0", mnemonic: true, chainId: 1666600000 },
  { name: 'Metis',        group: 'EVM', logo: 'images/metis.png',     curve: 'secp256k1', addrLen: 42, encoding: 'Hex (0x)', derivation: "m/44'/60'/0'/0/0", mnemonic: true, chainId: 1088 },
  { name: 'Mantle',       group: 'EVM', logo: 'images/mantle.png',    curve: 'secp256k1', addrLen: 42, encoding: 'Hex (0x)', derivation: "m/44'/60'/0'/0/0", mnemonic: true, chainId: 5000 },
  { name: 'Linea',        group: 'EVM', logo: 'images/linea.png',     curve: 'secp256k1', addrLen: 42, encoding: 'Hex (0x)', derivation: "m/44'/60'/0'/0/0", mnemonic: true, chainId: 59144 },
  { name: 'Scroll',       group: 'EVM', logo: 'images/scroll.png',    curve: 'secp256k1', addrLen: 42, encoding: 'Hex (0x)', derivation: "m/44'/60'/0'/0/0", mnemonic: true, chainId: 534352 },
  { name: 'Blast',        group: 'EVM', logo: 'images/blast.png',     curve: 'secp256k1', addrLen: 42, encoding: 'Hex (0x)', derivation: "m/44'/60'/0'/0/0", mnemonic: true, chainId: 81457 },
  { name: 'Mode',         group: 'EVM', logo: 'images/mode.png',      curve: 'secp256k1', addrLen: 42, encoding: 'Hex (0x)', derivation: "m/44'/60'/0'/0/0", mnemonic: true, chainId: 34443 },
  { name: 'Manta',        group: 'EVM', logo: 'images/manta.png',     curve: 'secp256k1', addrLen: 42, encoding: 'Hex (0x)', derivation: "m/44'/60'/0'/0/0", mnemonic: true, chainId: 169 },
  { name: 'Zora',         group: 'EVM', logo: 'images/zora.png',      curve: 'secp256k1', addrLen: 42, encoding: 'Hex (0x)', derivation: "m/44'/60'/0'/0/0", mnemonic: true, chainId: 7777777 },
